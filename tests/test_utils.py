...
class LoadConfTest(BaseTest):
    def test_load_config_section_none_existance_file(self):
        """Unittest for checking non existance config file"""
        with self.assertRaises(Exception):
            utils.load_config_section("", conf_address="")
